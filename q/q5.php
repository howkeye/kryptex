...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='5' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 5</u></h2></center></div>  </div>
				...
				<br><center>	
				AAAAARGHHH! <br><br>
U ask me if I am fine. Am I fine? <br><br>
[In squeaky voice] I’m fine. <br><br>
The thing is someone ate my sandwich! My sandwich! That sandwich was the only good thing that has ever happened to me! Someone asked me to get over it! When was I even under it?<br><br> 
DUH!
