...
?>
 ...
 function answer($input){
  ...
  if($ans=="backstreetboys"){
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='13' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 13</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				Not everyone has a fairytale love story in their life, especially when you have grown up being lonely. In a world like this people don’t understand you easily, although you know that your life is incomplete without her, just tell her to quit playing games and that you’ll be waiting for her as long as she loves you. Explain her that this is something that is larger than life for you and you don’t want to gamble away your chances.  I’m not that blonde country girl who made it to the top of this world but we have much deeper feeling than her.
