...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='20' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 20</u></h2></center></div>  </div>
...
<br><br>"And what one nation on the earth is
...
<br><br>"Ariel is an independent, headstrong 
...
<br><br>"It had the body of an over-large 
...
</br></br></br>Okay...so what goes in the textbox?
