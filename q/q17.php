...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='17' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<br><center>	
				I don’t want to lose like how Uber lost in China and in other parts of the world. I’m just going to try hard to stay in this competition. I am actually going to use her as much as I can to increase my revenue and now I’ve actually decided to go desi. OMG! She is invincible. <br><br>
