...
?>
 ...
 function answer($input){
  ...
  if($ans=="austinoscaru" or $ans=="oscaruaustin"){
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='6' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 6</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				To attend a meeting of world class scientists, A famous chemist from India visit Switzerland.<br><br> In the lab, the scientist was killed and his six assistants were under suspicion of killing the chemist. Name of six assistants: Austin, Rajat, Sam, Oscaru, Benny, and Rojo. He left a note "76-20-44 79-16-22-7" <br><br>

Hercule Poirot was called to solve the case. After reading the note, he instantly asked the police to arrest the murderers. 
<br><br>
Who are the murderers?<br><br>
If answers are Rajat and Sam, you can write <b>RajatSam</b> or <b>SamRajat</b>.
