...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='16' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 16</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				HERE was a sound of revelry by night,<br><br>
And Belgium's capital had gathered then<br><br>
Her beauty and her chivalry, and bright<br><br>
The lamps shone o'er fair women and brave men.<br><br>
A thousand hearts beat happily; and when<br><br>
Music arose with its voluptuous swell,<br><br>
Soft eyes looked love to eyes which spake again,<br><br>
And all went merry as a marriage bell;<br><br>
But hush! hark! a deep sound strikes like a rising knell!<br><br>
