...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='14' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 14</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				 I’ll tell you something really cool.<br><br>
Once I was taking a late-night walk when I saw a weird old man talking to a cat. He had a flowing white beard and wore a cloak.
I hid behind a bush and heard – “Yeah that’s why I gave him a fake surname! I even dedicated my left knee for his creation!” 
<br><br>
Apparently so that guy was talking about a person with a fake name. Can you find out the fake name?
