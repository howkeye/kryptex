...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='10' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 10</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				 Once Sheldon’s mother suggested him to learn something different. Like learning a sport or some instrument. Sheldon wasn’t interested but wanted to give it a try to keep his mother’s heart. His sister, Missy mocked him by saying “You said you can find all the answers in that fat book of yours. Now how will you choose what to do?” Sheldon just kept on staring at his book and the answer to the last question he solved -33.867886 degree Celsius and -63.987 degree Celsius. <br><br>

Can these numbers help him? Or is he delusional about the abilities of his book? 
