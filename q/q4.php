...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='4' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 4</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				I am a drawing or maybe a cartoon.<br><br> You can find me at the same place, but only on special occasions. <br><br>However small the occasion be, I depict it in a very interesting and creative way !<br><br> Can't guess who I am?<br><br> Google me away!
</center></div>  </div>
