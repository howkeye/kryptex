...
echo "<script type='text/javascript'>alert('Correct Answer');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='18' WHERE username='$user'";
  ...
  if($ans)
     ...
     ?>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 18</u></h2></center></div>  </div>


				<div class=" container  w3l-heading" >
						<div class="rj3" style="align-content: center;padding: 2vw; margin:2vw; margin-top:auto; color:white; ">
				<br><center>	
				The beginning, the returns, the cruise, the fugitive and the negotiation. Ha, ha! Who are you kidding? I’m not some Osama binladen that you can kill easily. I’m the one, who even the world’s best cop can’t arrest.<br><br> I’m really interested to find out how your yogurt loving bodybuilder and that food obsessed chipmunk along with your crazy crew are going to catch me. 
