...
?>
 ...
 function answer($input){
	...
	$ans=answer($_POST["ans"]);
  	...
  	if($_SESSION['check']==20){
	echo "<script type='text/javascript'>alert('Congrats you have tried harder');</script>";
     $user=$_SESSION['user'];
	$sql1 = "UPDATE leaderboard SET level='12' WHERE username='$user'";
...
<div class=" container" style=" color:red;"><center>
 <?php
  ...
  if($ans){
     ...
     echo " Wrong".$_SESSION['check']."Answer!!".$ans;
 	}
     ?>
     </center>  </div>
        ...
        <div class=" container  w3l-heading" >
				...
				<center>	 <h2><u>Question 12</u></h2></center></div>  </div>
