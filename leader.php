...
<body>
		...
		<div class="agileinfo-dot">
			<div class="header">
             ...
             <div class=" container  w3l-heading" >
				...
				<center>	 <h2>Leaderboard</h2></center></div>  </div>
  ...
  <div class="col-sm-8">
    ...
    <tbody>
	<?php 
	$sql = "SELECT * FROM leaderboard ORDER BY level DESC";
  ...
  Stucked in any question- checkout our <a href="https://www.facebook.com/Kryptex18" style="color: blue;"> facebook page.</a>
</div>
  </center></div>  </div>
  </div>
...
<div class=" container  w3l-heading"  >
  ...
  <div class="col-sm-8">
	...
	<?php 
	$user=$_SESSION["user"];
	$sql2 = "SELECT * FROM leaderboard where username= '$user' ";
